...
class Fawry1
{
    ...
    private  $developmentUrl = 'https://atfawry.fawrystaging.com/ECommerceWeb/Fawry';
    private $productionUrl = 'https://www.atfawry.com/ECommerceWeb/Fawry';
    ...
    public function __construct()
    {
        ...
        $this->baseUri = config('fawry.debug') ? $this->developmentUrl : $this->productionUrl;
    }

    public function createCardToken($cardNumber, $expiryYear, $expiryMonth, $cvv, $user)
    {
        $response = Http::post("$this->baseUri/cards/cardToken", [
